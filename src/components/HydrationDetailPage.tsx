...
export const HydrationDetailPage: React.FC<HydrationDetailPageProps> = ({
  ...
  return (
    <div className="fixed inset-0 h-screen w-full bg-gradient-to-b from-[#FAF7F2] to-[#F4F0E2] text-[#4F3F34] overflow-hidden select-none flex flex-col justify-between z-[200]">
      ...
      <div className="flex-1 w-full max-w-3xl mx-auto px-4 xs:px-6 flex flex-col items-center justify-center relative z-40 -mt-4 min-[370px]:-mt-8 md:-mt-10 pb-12 md:pb-20">
        ...
        <div className="flex flex-row items-center justify-center gap-3.5 sm:gap-8 md:gap-14 w-full">
          ...
          <div className="flex items-center justify-center flex-shrink-0 animate-in fade-in duration-500">
            <div className="relative w-[115px] h-[270px] min-[370px]:w-[130px] min-[370px]:h-[300px] xs:w-[155px] xs:h-[350px] sm:w-[180px] sm:h-[420px] md:w-[218px] md:h-[512px] drop-shadow-[0_15px_35px_rgba(14,165,233,0.18)] md:drop-shadow-[0_25px_60px_rgba(14,165,233,0.22)]">
          ...
          <div className="flex flex-col items-start text-left space-y-4 xs:space-y-6 md:space-y-8 max-w-[160px] min-[370px]:max-w-[190px] xs:max-w-[210px] sm:max-w-xs md:max-w-sm w-full text-[#4F3F34]">
            ...
            <motion.div 
              ...
              className="glass-card bg-white/70 backdrop-blur-md rounded-[1.3rem] min-[370px]:rounded-[1.6rem] md:rounded-[2.2rem] p-2.5 min-[370px]:p-3.5 md:p-6 border border-[#E9E4D4] shadow-xl w-full flex items-center gap-2 md:gap-5 relative overflow-hidden"
            >
              ...
              <div className="relative w-11 h-11 min-[370px]:w-13 min-[370px]:h-13 xs:w-15 xs:h-15 sm:w-16 sm:h-16 md:w-20 md:h-20 flex-shrink-0 flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex items-center justify-center pl-0.5 pt-0.5">
                  ...
                  >
                    <svg className="w-4 h-4 min-[370px]:w-5 min-[370px]:h-5 xs:w-6 xs:h-6 md:w-7 md:h-7 text-[#0ea5e9] drop-shadow-[0_2px_4px_rgba(14,165,233,0.3)]" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z" />
                    </svg>
                  </motion.div>
                </div>
              ...
              <div className="flex flex-col text-left space-y-0.5 select-none min-w-0 flex-1">
                <span className="text-blue-900/40 text-[8px] xs:text-[9px] md:text-[10px] font-black tracking-wider xs:tracking-widest uppercase truncate">
                  Today's Water
                </span>
                ...
                <div className="h-5 md:h-8 flex items-center">
                  <AnimatePresence mode="popLayout">
                    <motion.span
                      ...
                      className="text-xs min-[370px]:text-sm sm:text-base md:text-2xl font-black text-[#0ea5e9] tracking-tight block truncate"
                    >
                ...
                <div className="h-4 flex items-center">
                  <AnimatePresence mode="popLayout">
                    <motion.span
                      ...
                      className="text-[#0ea5e9]/60 font-semibold text-[8px] xs:text-[10px] sm:text-xs tracking-tight block truncate"
                    >
            ...
            <motion.div 
              ...
              className="flex flex-col items-start space-y-0.5 w-full pl-1 min-[370px]:pl-2"
            >
              <div className="flex items-baseline gap-1 xs:gap-2">
                <span className="text-5xl min-[370px]:text-6xl xs:text-7xl sm:text-8xl md:text-[8rem] font-sans font-black tracking-tighter text-[#0ea5e9] leading-none drop-shadow-[0_4px_15px_rgba(14,165,233,0.18)] md:drop-shadow-[0_6px_25px_rgba(14,165,233,0.22)] select-none">
                  {consecutiveDays}
                </span>
                <span className="text-2xl min-[370px]:text-3xl sm:text-4xl text-[#0ea5e9] select-none animate-bounce" style={{ animationDuration: "4s" }}>🔥</span>
              </div>
              <span className="text-[#0ea5e9]/60 font-black text-[8px] min-[370px]:text-[9px] sm:text-xs tracking-[0.1em] xs:tracking-[0.2em] uppercase">
