...
export const PLANT_ARCHETYPES: Record<string, PlantArchetype> = {
  ...
  "luck-lotus": {
    ...
    xpReward: 80,
    coinReward: 75,
    themeColor: "text-pink-500 bg-pink-50 border-pink-200",
  },
  "luck-fern": {
    id: "luck-fern",
    name: "Golden Fortune Fern",
    rarity: "Epic",
  ...
  "luck-clover": {
    ...
    xpReward: 150,
    coinReward: 180,
    themeColor: "text-yellow-500 bg-yellow-50 border-yellow-200",
  },
  "luck-orchid": {
    id: "luck-orchid",
    name: "Astra Velvet Orchid",
    rarity: "Legendary",
  ...
  "luck-cactus": {
    ...
    xpReward: 110,
    coinReward: 140,
    themeColor: "text-green-500 bg-green-50 border-green-200",
  },
};
