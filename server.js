...
var require_db = __commonJS({
  "node_modules/body-parser/node_modules/mime-db/db.json"(exports, module) {
    module.exports = {
...
var require_mime_db = __commonJS({
  "node_modules/body-parser/node_modules/mime-db/index.js"(exports, module) {
    module.exports = require_db();
  }
});

// node_modules/body-parser/node_modules/mime-types/mimeScore.js
var require_mimeScore = __commonJS({
  "node_modules/body-parser/node_modules/mime-types/mimeScore.js"(exports, module) {
    var FACET_SCORES = {
      "prs.": 100,
      "x-": 200,
      "x.": 300,
...
var require_mime_types = __commonJS({
  "node_modules/body-parser/node_modules/mime-types/index.js"(exports) {
    "use strict";
...
var require_media_typer = __commonJS({
  "node_modules/body-parser/node_modules/media-typer/index.js"(exports) {
    "use strict";
...
var require_type_is = __commonJS({
  "node_modules/body-parser/node_modules/type-is/index.js"(exports, module) {
    "use strict";
...
var firebaseConfigPath = path.join(process.cwd(), "firebase-applet-config.json");
...
var db = getFirestore(admin.app(), firebaseConfig.firestoreDatabaseId);
var startScheduler = () => {
  ...
  setInterval(async () => {
    ...
    try {
      ...
      for (const userDoc of usersSnapshot.docs) {
        ...
        if (!userData.notificationsEnabled || !fcmToken) continue;
        let userTimeStr = "";
        try {
        ...
        if (userTimeStr === userData.reminderTime || userTimeStr === userData.reminderTime2) {
          await sendPush(fcmToken, "Nexora \u{1F525}", "Hey \u{1F44B} Ready for today\u2019s challenge? Don't let that streak die!");
        }
        if (userTimeStr === (userData.motivationTime || "12:00")) {
          const quotes = [
            "The only way to do great work is to love what you do. \u{1F525}",
            "Believe you can and you're halfway there. \u{1F680}",
            "Push yourself, because no one else is going to do it for you. \u{1F4AA}",
            "Great things never come from comfort zones. \u{1F3C6}"
          ];
          const quote = quotes[Math.floor(Math.random() * quotes.length)];
          await sendPush(fcmToken, "Daily Motivation! \u{1F4A1}", quote);
        }
      }
      const plansSnapshot = await db.collection("customPlans").get();
      for (const planDoc of plansSnapshot.docs) {
        const plan = planDoc.data();
        const userDoc = await db.collection("users").doc(plan.userId).get();
        const userData = userDoc.data();
        if (!userData || !userData.fcmToken || !userData.notificationsEnabled) continue;
        const tz = userData.timezone || "UTC";
        const formatter = new Intl.DateTimeFormat("en-GB", {
          hour: "2-digit",
          minute: "2-digit",
        ...
        if (plan.days.includes(localDay)) {
          if (userTimeStr === plan.reminderTime || userTimeStr === plan.reminderTime2) {
            await sendPush(userData.fcmToken, `${plan.name} \u{1F680}`, `Time for your custom plan: ${plan.name}! Let's go!`);
          }
        }
      }
    } catch (error) {
        ...
        if (lastKnownVersion && lastKnownVersion !== newVersion) {
          ...
          if (tokens.length > 0) {
            await admin.messaging().sendEachForMulticast({
              tokens,
              notification: {
                title: `New Nexora Update! \u{1F680} v${newVersion}`,
...
var sendPush = async (token, title, body) => {
  try {
...
var MOTIVATIONAL_QUOTES = [
  { title: "Crush It Bro! \u{1F680}", body: "Don't let your streak die today. You're a beast!" },
  { title: "Level Up! \u{1F525}", body: "Consistency is the key to greatness. Get your habits done!" },
  { title: "Nexora Power \u26A1", body: "Small wins every day lead to massive results. Keep going!" },
  { title: "Stay Disciplined \u{1F9E0}", body: "Motivation gets you started, discipline keeps you going." },
  { title: "No Excuses \u{1F6AB}", body: "Your future self will thank you for the work you do today." },
  { title: "Champion Mindset \u{1F3C6}", body: "Champions keep playing until they get it right. Let's go!" },
  { title: "Focus Bro! \u{1F3AF}", body: "Distractions are the enemy of progress. Stay focused on your goals." }
];
async function startServer() {
  const app = express();
  const PORT = 3e3;
  app.use("/api/webhook/lemonsqueezy", import_body_parser.default.raw({ type: "application/json" }));
